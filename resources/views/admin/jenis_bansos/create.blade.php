...
<head>
    ...
    <title>Tambah Jenis Bantuan Sosial</title>
...
<div class="container mt-5 mb-5">
    <div class="card shadow">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="bi bi-file-earmark-plus-fill me-2"></i>Form Tambah Jenis Bantuan Sosial</h5>
        ...
        <div class="card-body p-4">
            ...
            <form action="{{ route('jenis-bansos.store') }}" method="POST">
                @csrf <h6 class="text-primary border-bottom pb-2 mb-3">I. Identitas Bantuan</h6>
                <div class="row mb-3">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="kode_bansos" class="form-control text-uppercase" placeholder="BLT-DD">
                    </div>
                    <div class="col-md-5">
                        ...
                        <select name="sumber_dana" class="form-select" required>
                            ...
                            <option value="Swasta">Lainnya/CSR</option>
                        </select>
                    </div>
                    <div class="col-12 mt-2">
                        <label class="form-label">Deskripsi Singkat</label>
                        <textarea name="deskripsi" class="form-control" rows="1" placeholder="Jelaskan tujuan bantuan ini secara singkat..."></textarea>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select name="bentuk_bantuan" class="form-select" required>
                            ...
                            <option value="Rekening Bank">Saldo Rekening</option>
                            <option value="Barang">Sembako</option>
                            <option value="Jasa">Beasiswa KIP</option>
                            <option value="Jasa">Jaminan Kesehatan</option>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Nominal/Jumlah</label>
                        <input type="text" name="nominal" class="form-control" placeholder="Contoh: 300.000 atau 10kg" required>
                    </div>
                    <div class="col-md-4">
                        ...
                        <select name="frekuensi" class="form-select" required>
                            ...
                            <option value="Insidental">Sekali Cair</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-8">
                        ...
                        <textarea name="kriteria_penerima" class="form-control" rows="3" placeholder="Contoh: Warga lansia, tidak bekerja, rumah lantai tanah..." required></textarea>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="batas_penghasilan" class="form-control" placeholder="0">
                                </div>
                            </div>
                            <div class="col-md-6 d-flex align-items-center mt-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="syarat_dtks" value="1" id="switchDTKS">
                    ...
                    <div class="col-md-4 bg-white border rounded p-3">
                        <div class="mb-3">
                            ...
                            <input type="number" name="tahun_anggaran" class="form-control" value="{{ date('Y') }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Kuota (Orang)</label>
                            <input type="number" name="kuota_penerima" class="form-control">
                        </div>
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="radio" name="status" value="Aktif" id="statusAktif" checked>
                            <label class="form-check-label text-success fw-bold" for="statusAktif">Program Aktif</label>
                        </div>
                        <div class="form-check form-switch mt-2">
                            <input class="form-check-input" type="radio" name="status" value="Non-Aktif" id="statusNon">
                ...
                <div class="mt-4 pt-3 border-top d-flex justify-content-end">
                    ...
                    <button type="submit" class="btn btn-primary px-4"><i class="bi bi-save me-2"></i>Simpan Jenis Bantuan</button>
                </div>
            </form>
        </div>
    </div>
