...
class UserController extends Controller
{
    ...
    public function storeRT(Request $request)
    {
        ...
        $request->validate([
            ...
            'wilayah_rt_rw' => 'required|string|max:20|unique:users,wilayah_rt_rw',
        ...
        User::create([
            ...
            'password' => $request->password, // Password otomatis di-hash jika ada casts 'hashed' di Model
            'role' => 'RT',
        ]);

        return redirect()->route('admin.rt.index')->with('success', 'Akun Ketua RT berhasil ditambahkan! Silakan atur kuota manualnya di Pusat Konfigurasi jika diperlukan.');
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        $request->validate([
            'username' => 'required|unique:users,username,'.$user->id_user,
